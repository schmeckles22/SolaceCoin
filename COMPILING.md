...
Solace uses the CMake build system and a top-level [Makefile](Makefile) that
...
* Install the dependencies for Solace except libunwind and libboost-all-dev
...
You will have to add the serialization, date_time, and regex modules to Boost when building as they are needed by Solace.
...
This section contains general instructions for debugging failed installs or problems encountered with Solace. First ensure you are running the latest version built from the github repo.
